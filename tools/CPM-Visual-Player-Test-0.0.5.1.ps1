...
Write-Host "CPM 0.0.5.1: Player visual $playerId conectado." -ForegroundColor Green
Write-Host "O NPC sera criado perto da posicao atual do seu personagem." -ForegroundColor Cyan
Write-Host "Nao e necessario usar coordenadas ou teleporte. Teste de 45 segundos." -ForegroundColor Cyan
